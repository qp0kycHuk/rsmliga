...
function init() {
  document.addEventListener('click', function (event) {
    if (event.target.closest('.color-select-item')) {
      var value = event.target.closest('.color-select-item').getAttribute('data-color');
      var cover = event.target.closest('.color-select');
      var input = cover.querySelector('.color-select-input');
      var titleItem = cover.querySelector('.color-select-title .color-select-item');
...
/* harmony import */ var npm_kit_ripple__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! npm-kit-ripple */ "./node_modules/npm-kit-ripple/index.js");
/* harmony import */ var _js_fancybox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/fancybox */ "./src/js/fancybox.js");
/* harmony import */ var _js_color_select__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/color-select */ "./src/js/color-select.js");
/* harmony import */ var _js_show_pass__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/show-pass */ "./src/js/show-pass.js");
...
/* harmony import */ var air_datepicker_air_datepicker_css__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! air-datepicker/air-datepicker.css */ "./node_modules/air-datepicker/air-datepicker.css");
...
window.ripple = npm_kit_ripple__WEBPACK_IMPORTED_MODULE_4__["default"];
...
document.addEventListener('toggleclose', menuCloseHandler); // menu toggle handlers
...
function loadHandler() {
  _js_fancybox__WEBPACK_IMPORTED_MODULE_5__["default"].init();
  npm_kit_tab__WEBPACK_IMPORTED_MODULE_2__["default"].init();
  npm_kit_toggle__WEBPACK_IMPORTED_MODULE_3__["default"].init();
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_4__["default"].init();
  _js_color_select__WEBPACK_IMPORTED_MODULE_6__["default"].init();
  _js_show_pass__WEBPACK_IMPORTED_MODULE_7__["default"].init();
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_4__["default"].attach('.btn');
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_4__["default"].attach('.waved');
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_4__["default"].attach('.news-card');
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_4__["default"].attach('.slider-btn');
  npm_kit_ripple__WEBPACK_IMPORTED_MODULE_4__["default"].deAttach('.btn--link');
}
})();
